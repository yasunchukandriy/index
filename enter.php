...
<div id="login-box-name" style="margin-top:10px;"><?php print(translate('Login',$_SESSION['language']))?>:</div>
	<div id="login-box-field" style="margin-top:10px;">
	<input name="login" class="form-login" title="login" value="" size="30" maxlength="2048" required/></div>
<div id="login-box-name"><?php print(translate('Password',$_SESSION['language']))?>:</div>
	<div id="login-box-field">
	<input name="password" type="password" class="form-login" title="password" value="" size="30" maxlength="2048" required/></div>
