...
<script> 
    function check(){
        ...
        var fPass2 = document.getElementById('password2');
        var fEmail = document.getElementById('email');
        var reg_pusto = new RegExp('([^\\s*]+)','g');
        if (fLogin.value.length<3){
            alert('Логін не може бути менше 3-х символів!');
            return false;
        }
        if (fPass.value.length<5){

            alert('Пароль не може бути менше 5-ти символів!');
            return false;
        }
	...
	<div id="login-box">
	<H2>Registration</H2>
	<form id='forma' action='reg.php' method='post' onsubmit="return check()">
<div id="login-box-name" style="margin-top:10px;">Login:</div>
	<div id="login-box-field" >
	<input id="login" name="login" class="form-login" title="login" value="" size="30" maxlength="2048" /></div>
<div id="login-box-name">Password:</div>
	<div id="login-box-field">
	<input id="password" name="password" type="password" class="form-login" title="password" value="" size="30" maxlength="2048" /></div>
<div id="login-box-name">Repeat password:</div>
	<div id="login-box-field">
	<input id="password2" name="password2" type="password" class="form-login" title="password2" value="" size="30" maxlength="2048" /></div>
<div id="login-box-name" style="margin-top:10px;">Email:</div>
	<div id="login-box-field" style="margin-top:10px;">
	<input id="email" name="email" title="email" class="form-login" value="" size="30" maxlength="2048" /></div>
<a href="index.php" style="margin-right:300px;">Log</a>
	<input type=image src=/img/11.png  name='submit' value='Log in' alt='Go!' border=0 style="margin-left:150px; margin-buttom:300px;">
	</form>
	</div>
</div>
</body>
